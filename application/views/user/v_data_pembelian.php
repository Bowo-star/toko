...
<section>
    ...
    <div class="leftpanelinner">
     ...
     <br>
      ...
      <h5 class="sidebartitle">Data Master</h5>
        ...
        <li  class="active"><a href="<?php echo base_url();?>c_toko/tampilpembelian"><i class="fa fa-book"></i> <span>Data Transaksi</span></a></li>
      </ul>
  ...
  <div class="mainpanel">
   ...
   <div class="pageheader">
      <h2><i class="fa fa-book"></i> <span>Data Transaksi</span></h2>
      <div class="breadcrumb-wrapper">

      
        <ol class="breadcrumb">
          <li><a href="<?php echo base_url();?>c_toko/dashboardadmin">Admin</a></li>
          <li><a href="<?php echo base_url();?>c_barang">Transaksi</a></li>
            ...
            <table class="table" id="table1">
              ...
              <tbody>
                 <?php
                  ...
                  <td>
  <a class="btn btn-lightblue btn-xs" href='<?php echo base_url()."c_toko/ubah_pembelian/".$data['id_pembelian'];?>'><i>Proses</i></a>
                </td> 
                  </tr>
                  <?php $no++;?>
                  <?php } ?>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">Data Transaksi Custom</h3>
        </div>
          ...
          <div class="table-responsive">
            <table class="table" id="table1">
              ...
              <tbody>
                 <?php
                  $no = 1;
                  foreach ($pembelianmember as $data) { ?>

                  <tr>
                  <td hidden="1"><?php echo $no; ?></td>
                  <td hidden="1"><?php echo $data['id_pembelianm']; ?></td>
                  <td><?php echo $data['nik']; ?></td>
                  ...
                  <td><?php echo $data['status']; ?></td>
                  <td>
  <a class="btn btn-lightblue btn-xs" href='<?php echo base_url()."c_toko/ubah_pembelianmember/".$data['id_pembelianm'];?>'><i>Proses</i></a>
                </td> 
                  </tr>
                  <?php $no++;?>
                  <?php } ?>
