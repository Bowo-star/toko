...
<section>
  ...
  <div class="pageheader">
      <h2><i class="fa fa-home"></i> Form <span>Data Transaksi Custom</span></h2>
    ...
    <div class="contentpanel">
      ...
      <<div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="error"></div>
            <form action="<?php echo base_url();?>c_toko/proses_edit_pembelianmember" method="post">

                 <div class="form-group">
                  <label class="col-sm-3 control-label">Id Pembelian</label>
                  <div class="col-sm-7">
                    <input readonly="true" type="text" name="id_pembelian" class="form-control"  value="<?php echo $pembelianmember->id_pembelianm;?>" maxlength="15" required />
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input readonly="true" type="text" name="nik" class="form-control"  value="<?php echo $pembelianmember->nik;?>" maxlength="15" required />
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input readonly="true" type="text" name="nama_member" class="form-control"  value="<?php echo $pembelianmember->nama_member;?>" maxlength="15" required />
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input readonly="true" type="text" name="alamat" class="form-control"  value="<?php echo $pembelianmember->alamat;?>" maxlength="15" required />
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input readonly="true" type="text" name="no_telp" class="form-control"  value="<?php echo $pembelianmember->no_telp;?>" maxlength="15" required />
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input readonly="true" type="text" name="nama_produk" class="form-control"  value="<?php echo $pembelianmember->nama_produk;?>" maxlength="15" required />
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input readonly="true" type="text" name="jumlah" class="form-control"  value="<?php echo $pembelianmember->jumlah;?>" maxlength="15" required />
                  </div>
                </div>
                  ...
                  <div class="col-sm-7">
                    <input readonly="true" type="text" name="jumlah" class="form-control"  value="<?php echo $pembelianmember->deskripsi;?>" maxlength="15" required />
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input id="datepicker" name="tanggal" class="form-control"  value="<?php echo $pembelianmember->tanggal;?>" maxlength="15" required />
                  </div>
                </div>
