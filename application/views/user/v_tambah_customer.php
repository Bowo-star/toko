...
<section>
  ...
  <div class="pageheader">
      <h2><i class="fa fa-home"></i> Form <span>Data Customer</span></h2>
    ...
    <div class="contentpanel">
      ...
      <<div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="error"></div>
            <form action="<?php echo base_url();?>c_toko/input_user" method="post">

                 <div class="form-group">
                  <label class="col-sm-3 control-label">NIK<span class="asterisk">*</span></label>
                  <div class="col-sm-7">
                    <input type="text" name="nik" onkeypress="return hanyaAngka(event)" maxlength="16" class="form-control"  placeholder="Masukan NIK" maxlength="12" required />
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="password" name="password" id="password-input" class="form-control"  placeholder="Masukan Password" required />
                  </div>
                </div>
                 <div class="checkbox">
                  <label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="no_telp" class="form-control"  placeholder="Masukan No Telepon" maxlength="13" required />
                  </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
  function validasihuruf(a){
    if(!/^[A-Za-z _]+s/.test(a.value)){
      a.value = a.value.substring(0,a.value.length-1000);
    }
  }
</script>
