...
<section>
  ...
  <div class="mainpanel">
   ...
   <div class="pageheader">
      <h2><i class="fa fa-book"></i> <span>Data User</span></h2>
      <div class="breadcrumb-wrapper">


        <ol class="breadcrumb">
          <li><a href="<?php echo base_url();?>c_toko/dashboardadmin">Admin</a></li>
          <li><a href="<?php echo base_url();?>c_toko/tampiluser">Data User</a></li>
              ...
              <tbody>
                 <?php
                  ...
                  <td><?php echo $data['alamat']; ?></td>
									<td>
  <a class="btn btn-lightblue btn-xs" href='<?php echo base_url()."c_toko/ubah_user/".$data['nik'];?>'><i class="fa fa-edit"></i></a>
  <a class="btn btn-orange btn-xs" href="<?php echo base_url()."c_toko/hapus_user/".$data['nik'];?>"><i class="fa fa-trash-o"></i></a>
								</td>	
                </tr>
									<?php $no++;?>
									<?php } ?>
           ...
           <center> <a href="<?php echo base_url();?>c_toko/tambah_user"><button class="btn btn-success"> Tambah Data</button></a></center><br><br>
