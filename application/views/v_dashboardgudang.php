...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        <li class="active"><a href="<?php echo base_url();?>c_toko/dashboardgudang"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>

      <h5 class="sidebartitle">Data Master</h5>

        <li><a href="<?php echo base_url();?>c_toko/tampilproduk"><i class="fa fa-book"></i> <span>Data Produk</span></a></li>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> <span>Petugas Gudang</span></h2>
    ...
    <div class="contentpanel">
     <div class="panel panel-info">
            ...
            <center><img height="175" src="<?php echo base_url()."assets/"; ?>images/petugas.jpg">
              <h4><p>Selamat datang anda masuk sebagai <b>Petugas Gudang.</b></p><br></center></h4>
               <div class="col-md-7">
