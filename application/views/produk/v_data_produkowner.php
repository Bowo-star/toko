    ...
    <div class="leftpanelinner">
     ...
     <br>
      <ul class="nav nav-pills nav-stacked nav-bracket">
        <li><a href="<?php echo base_url();?>c_toko/dashboardowner"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>

      <h5 class="sidebartitle">Data Master</h5>

        <li  class="active"><a href="<?php echo base_url();?>c_toko/tampilprodukowner"><i class="fa fa-book"></i> <span>Data Produk</span></a></li>
      </ul>
