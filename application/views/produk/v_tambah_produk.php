      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="error"></div>
            ...
            <form action="<?php echo base_url();?>c_toko/input_produk" method="post">

                 <div class="form-group">
                  <label class="col-sm-3 control-label">ID Produk<span class="asterisk">*</span></label>
                  <div class="col-sm-7">
                    <input type="text" name="id_produk"  class="form-control"  placeholder="Masukan Id" maxlength="10" required />
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    ...
                    <option>- Pilih -</option>
                    <option>-----------</option>
                      <option>Jam Analog</option>
                      <option>Jam Digital</option>
                        <option>-----------</option>
                        <option>Bazel</option>
                        <option>Glass</option>
                        <option>Bracklet</option>
               ...
               <div class="form-group">
                  <label class="col-sm-3 control-label">Harga Rp.<span class="asterisk">*</span></label>
                  <div class="col-sm-7">
                    <input type="text" name="harga" onkeypress="return hanyaAngka(event)" class="form-control" maxlength="10"  placeholder="Masukan Harga Barang" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="stok" onkeypress="return hanyaAngka(event)" class="form-control" maxlength="3"  placeholder="Masukan Stok Barang" required />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">Deskripsi<span class="asterisk">*</span></label>
                  <div class="col-sm-7">
                    <input type="text"  name="deskripsi" id="satuan"  class="form-control" placeholder="Pcs/lusin/dll" required />
                  </div>
                </div>
        </div>
