    ...
    <div class="leftpanelinner">
     ...
     <br>
      <ul class="nav nav-pills nav-stacked nav-bracket">
        <li><a href="<?php echo base_url();?>c_toko/dashboardmember"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>

      <h5 class="sidebartitle">Data Master</h5>

        <li  class="active"><a href="<?php echo base_url();?>c_toko/tampilprodukmember"><i class="fa fa-book"></i> <span>Lihat Produk</span></a></li>
      </ul>
   ...
   <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url();?>c_barang">Lihat Produk </a></li>
    ...
    <div class="contentpanel">
      <div class="panel panel-default">
       ...
       <div class="panel-body">
          ...
          <center> <a href="<?php echo base_url();?>c_toko/tambah_pembelianmember"><button class="btn btn-success"> Tambah Produk</button></a></center><br><br>      
        </div><!-- panel-body -->
