  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
        ...
        <ul class="nav nav-pills nav-stacked nav-bracket">
          ...
          <li class="active"><a href="<?php echo base_url();?>c_toko/tampilprodukcustomer"><i class="fa fa-book"></i> <span>Data Produk</span></a></li>
        </ul>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="error"></div>
            ...
            <form action="<?php echo base_url();?>c_toko/input_pembelian" method="post">
                 <div class="form-group">
                  <label class="col-sm-3 control-label">ID Pembelian<span class="asterisk">*</span></label>
                  <div class="col-sm-7">
                    <input type="text" readonly="1" value="<?= $this->m_toko->buat_kode();?>" name="id_pembelian" onkeypress="return hanyaAngka(event)" class="form-control" maxlength="10" required />
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="nik" onkeypress="return hanyaAngka(event)" class="form-control" maxlength="15"  placeholder="Masukan NIK" required />
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="nama_customer" class="form-control"  placeholder="Masukan Nama" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">No Telepon<span class="asterisk">*</span></label>
                  <div class="col-sm-7">
                    <input type="text"  name="no_telp" onkeypress="return hanyaAngka(event)" class="form-control" maxlength="13"  placeholder="Masukan No Telepon" required />
                  </div>
                </div>


                 <div class="form-group">
                  <label class="col-sm-3 control-label">Produk<span class="asterisk">*</span></label>
                  <div class="col-sm-7">
                    <select class="form-control" name='id_produk' id='id_produk' required>
                    <option> - Pilih - </option>
                    <?php foreach($produk as $a){?>
                      <option value='<?php echo $a['id_produk']?>'><?php echo $a['id_produk'].' - '.$a['nama_barang'] ;?></option>
                    <?php }?>
                  </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" readonly="true" name="nama_barang" id="nama_barang" class="form-control"  maxlength="15" placeholder="Nama Barang" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" readonly="true" name="stok" id="stok" class="form-control"  maxlength="15" placeholder="Stok Barang" required />
                  </div>
                </div>
                
               <div class="form-group">
                  <label class="col-sm-3 control-label">Jumlah Pesanan<span class="asterisk">*</span></label>
                  <div class="col-sm-7">
                    <input type="text" name="jumlah" onkeypress="return hanyaAngka(event)" class="form-control" maxlength="4"  placeholder="Masukan Jumlah Pesanan" required />
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-sm-3 control-label">Tgl. Pembelian<span class="asterisk">*</span></label>
                  <div class="col-sm-7">
                    <input id="datepicker" name="tanggal" class="form-control"  placeholder="00-00-0000" />
                  </div>
                </div>
