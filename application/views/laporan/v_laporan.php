...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        <li class="active"><a href="<?php echo base_url();?>c_inventory/dashboardkepala"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>

  
       <h5 class="sidebartitle">Laporan</h5>
       <ul class="nav nav-pills nav-stacked nav-bracket">
        <li><a href="<?php echo base_url();?>c_inventory/laporanbarang"><i class="fa fa-print"></i> <span>Laporan Barang</span></a></li>
      </ul>

      <ul class="nav nav-pills nav-stacked nav-bracket">
        <li><a href="<?php echo base_url();?>c_inventory/laporanbarangmasuk"><i class="fa fa-print"></i> <span>Laporan Barang Masuk</span></a></li>
      </ul>

      <ul class="nav nav-pills nav-stacked nav-bracket">
        <li><a href="<?php echo base_url();?>c_inventory/laporanbarangkeluar"><i class="fa fa-print"></i> <span>Laporan Barang Keluar</span></a></li>
      </ul>


       <h5 class="sidebartitle">Lainya</h5>
       <ul class="nav nav-pills nav-stacked nav-bracket">
        <li><a href="<?php echo base_url();?>root/user"><i class="fa fa-sign-out"></i> <span>Log out</span></a></li>
      </ul>
  ...
  <div class="mainpanel">
          ...
          <li>
           <div class="btn-group">
              ...
              <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                ...
                <li><a href="<?php echo base_url();?>c_inventory/do_logout"><i class="glyphicon glyphicon-log-out"></i> Log Out</a></li>
              </ul>
            </div>
          </li>
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> <span>Cetak Laporan</span></h2>
    ...
    <div class="contentpanel">
     <div class="panel panel-info">
            ...
            <center>
              <h4><p>Cetak Laporan.</p><br></center></h4>
               <div class="col-md-7">
