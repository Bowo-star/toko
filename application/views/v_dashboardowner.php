  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        <li class="active"><a href="<?php echo base_url();?>c_toko/dashboardowner"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>

      <h5 class="sidebartitle">Data Master</h5>

        <li><a href="<?php echo base_url();?>c_toko/tampilprodukowner"><i class="fa fa-book"></i> <span>Data Produk</span></a></li>
        <li><a href="<?php echo base_url();?>c_toko/laporantransaksi"><i class="fa fa-book"></i> <span>Laporan Keseluruhan</span></a></li>
      </ul>
  ...
  <div class="mainpanel">
    ...
    <div class="contentpanel">
     <div class="panel panel-info">
            ...
            <center><img height="175" src="<?php echo base_url()."assets/"; ?>images/kepala.jpg">
              <h4><p>Selamat datang anda masuk sebagai <b>Owner</b></p><br></center></h4>
               <div class="col-md-7">
